...
public class PrincipleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().getDecorView().setBackground(ContextCompat.getDrawable(PrincipleActivity.this, R.drawable.background_gradient));
        ...
        fullMoonReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists())
                        getWindow().getDecorView().setBackground(ContextCompat.getDrawable(PrincipleActivity.this, R.drawable.full_moon_background));
            }
