    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /*         switch (videoName){
                    ...
                    case "Thyagaraja Swami Dhana Aradhanostavalu Veena Meditaion Music by Ramavarapu Madhuri Devi":
                        ...
                        break;
                    case "Dr.GK Sir Class":
                        youTubePlayer.loadVideo("9030_idmV-0");
                        break;
                    case"Sirimuvvalu Mega Cultural Event":
                        youTubePlayer.loadVideo("MB_HmmYyoU4");
                        break;
                        case "Vishista ekaanta saadhana samayam (Quarantine time)":
                        youTubePlayer.loadVideo("_gVhsBiQZc8");
                        break;
                }*/
